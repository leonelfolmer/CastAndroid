...
public class VideoProvider {
    ...
    private static String TAG_STUDIO = "artist";
    private static String TAG_SOURCES = "sources";
    private static String TAG_SUBTITLE = "media_description";
            ...
            for (int i = 0; i < categories.length(); i++) {
                ...
                if (null != videos) {
                    for (int j = 0; j < videos.length(); j++) {
                        ...
                        String artist = video.getString(TAG_STUDIO);
                        ...
                        mediaList.add(buildMediaInfo(title, artist, subTitle, videoUrl, imageurl,
                                bigImageurl, tracks));
                    }
                }
            }
    ...
    private static MediaInfo buildMediaInfo(String title, String subTitle, String artist,
            String url, String imgUrl, String bigImageUrl, List<MediaTrack> tracks) {
        MediaMetadata movieMetadata = new MediaMetadata(MediaMetadata.MEDIA_TYPE_MOVIE);

        movieMetadata.putString(MediaMetadata.KEY_SUBTITLE, subTitle);
        movieMetadata.putString(MediaMetadata.KEY_TITLE, title);
        movieMetadata.putString(MediaMetadata.KEY_STUDIO, artist);
    ...
    private static MediaTrack buildTrack(long id, String type, String subType, String contentId,
        ...
        if (subType != null) {
            ...
            } else if ("media_description".equals(type)) {
